...
part of 'gi_fs_deprecated_api.dart';
...
class _GiFsDeprecatedApi implements GiFsDeprecatedApi {
  _GiFsDeprecatedApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<GifFeaturedResponse> getFeaturedKlipy({Locale? locale}) async {
    ...
    final _options = _setStreamType<GifFeaturedResponse>(
    ...
    late GifFeaturedResponse _value;
    try {
      _value = GifFeaturedResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<void> registerKlipyShare({
    required GifRegisterShareRequest body,
  }) async {
    final _extra = <String, dynamic>{};
  ...
  Future<List<GifResponse>> searchKlipy({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<GifResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/klipy/search',
    ...
    late List<GifResponse> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => GifResponse.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
