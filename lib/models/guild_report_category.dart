...
enum GuildReportCategory {
  ...
  const GuildReportCategory(this.json);

  factory GuildReportCategory.fromJson(String json) =>
  ...
  static List<GuildReportCategory> get $valuesDefined =>
