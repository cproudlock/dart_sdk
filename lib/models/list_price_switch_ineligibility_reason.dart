...
@JsonEnum()
enum ListPriceSwitchIneligibilityReason {
  ...
  const ListPriceSwitchIneligibilityReason(this.json);

  factory ListPriceSwitchIneligibilityReason.fromJson(String json) =>
  ...
  static List<ListPriceSwitchIneligibilityReason> get $valuesDefined =>
